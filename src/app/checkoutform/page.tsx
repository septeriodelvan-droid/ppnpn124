...
export default function PresensiOutForm() {
    ...
    const handleCheckOut = async () => {
        ...
        // Piket pagi:
        // checkout paling lambat 17.30 WIB pada attendance_date yang sama.
        //
        // Piket malam:
        // checkout paling lambat 07.15 WIB pada hari berikutnya.
        ...
        if (now.getTime() > checkOutDeadline.getTime()) {
            ...
            toast.error(
                `Presensi pulang ditolak. Batas checkout piket ${currentShift} adalah ${deadlineDate} pukul ${deadlineTime}.`
            );
            return;
        }
